//! This is a modified version of the chisel solidity helper.
//! https://github.com/foundry-rs/foundry/blob/a970b36d451fe84b8fba456ec99bf822376e56b8/crates/chisel/src/solidity_helper.rs#L275
...
use crate::{interpreter::Env, repl::completer::MyCompleter};
...
#[derive(Completer)]
pub(crate) struct SolidityHelper {
...
impl Highlighter for SolidityHelper {
    ...
    fn highlight_char(
        ...
        line: &str,
        pos: usize,
        _cmd_kind: rustyline::highlight::CmdKind,
    ) -> bool {
        pos == line.len()
    }
    ...
    fn highlight_prompt<'b, 's: 'b, 'p: 'b>(
        ...
        if prompt.starts_with("(ID: ") {
            ...
            out.replace_range(
                1..=2,
                &Self::paint_unchecked_owned("ID", Color::Cyan.foreground()),
            );
        }
